...
<nav class="navbar navbar-default navbar-static-top">
	...
	<div class="container-fluid main-container">
		...
		<div class="wrapper">              
              ...
              <input type="number" class="form-control" name="id" placeholder="Cédula" required="" autofocus="" />
              <input type="email" class="form-control" name="user" placeholder="Correo Electrónico" required="" autofocus="" />
