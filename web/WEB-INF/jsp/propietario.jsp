		...
		<div class="navbar-header">
			<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
				...
				<span class="icon-bar"></span>
                        ...
                        <a class="navbar-brand" href="cancha.htm" onclick="location.href='${pageContext.request.contextPath}/cancha.htm'">CANCHA LIBRE RESERVAS</a>
                ...
                <div>
                    <c:forEach items="${datos}" var="dato">
                        <div class="col-xs-6 col-sm-3 placeholder">
                               ...
                               <a href="<c:url value="Infocancha.htm?value=${dato.codcancha}?"/>"><img src="<c:url value="/images/${dato.path}"/>" width="700" height="700"
