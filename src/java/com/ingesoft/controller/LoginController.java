...
public class LoginController implements Controller{
        ...
        public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
        {
           ...
           if (qCount>0)
           {
                ...
                String tem = "select apellidos from tbusuario where correo=? and clave=?";
                String qapellido = jdbcTemplate.queryForObject(
                tem, new Object[] {userName,password}, String.class);
                ...
                if (q==2){
                    ...
                    mav.addObject("apellido", qapellido);
                    return mav;
                }else{
